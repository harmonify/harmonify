...
export const Card: React.FC<CardProps> = ({num}) => {
  return (
    <figure
      className="flex flex-shrink-0 relative w-80 h-96 md:w-96 md:h-124 bg-cover rounded-3xl hover:opacity-70 duration-200"
    ...
    >
      ...
      <section className="w-full h-full relative z-20 p-7 flex flex-col justify-between">
        ...
        <div className="space-y-1 text-white">
          <h3 className="text-4xl font-bold truncate">Project Title {num}</h3>
          <figcaption className="text-sm tracking-wider truncate">
            Project description
          </figcaption>
        </div>
      </section>
